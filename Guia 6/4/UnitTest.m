...
i_sinx2 = IntegracionTrapecios('f', @(x) (sin(x)).^2, 'a', 0, 'b', pi/3, 'n', 1);

if any(abs([a1 b1 c1 d1 a2 b2 c2 d2 i_sinx2] - ...
     [975.6 1323 3415.5 3686.4 1032.3 1512.9 3183.3 3418.2 0.3926991]) > 1e-6)
