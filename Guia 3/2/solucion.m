% Aplico CalcRaizBiseccion para encontrar las respuestas a los incisos
...
[~, ~, n, ~] = CalcRaizBiseccion('3*x+sin(x)-exp(x)', 0, 1, 10^(-3));
...
i = -1;
while 1
    [~, f_x, n, ~] = CalcRaizBiseccion('3*x+sin(x)-exp(x)', 0, 1, 10^i);
